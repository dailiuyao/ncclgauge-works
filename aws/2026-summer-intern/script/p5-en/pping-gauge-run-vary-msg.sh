...
MESSAGE_SIZES=(8 16 32 64)
MESSAGE_LABELS=("8B" "16B" "32B" "64B")
    ...
    for idx in "${!MESSAGE_SIZES[@]}"; do
        ...
        for mode in "${test_mode[@]}"; do
            ...
            /opt/amazon/openmpi/bin/mpirun \
                ...
                $NCCL_GAUGE_HOME/gauge/p5-en/${mode}_gauge_n_${n}.exe "0" "0"
        done
    done
done

echo "=== Gauge run complete for P5 ==="
