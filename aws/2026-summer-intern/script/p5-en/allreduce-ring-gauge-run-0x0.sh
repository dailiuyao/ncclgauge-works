...
export GAUGE_OUT_DIRE="$NCCL_GAUGE_HOME/out/p5-en"
...
MESSAGE_SIZES_Simple=(8589934592)
MESSAGE_LABELS_Simple=("8GB")
MESSAGE_SIZES_LL=(67108864)
MESSAGE_LABELS_LL=("64MB")
MESSAGE_SIZES_LL128=(1073741824)
MESSAGE_LABELS_LL128=("1GB")
   ...
   for nth in "${NTHREADS_LIST[@]}"; do
    ...
    for idx in "${!MESSAGE_SIZES[@]}"; do
        ...
        /opt/amazon/openmpi/bin/mpirun \
            ...
            $NCCL_GAUGE_HOME/gauge/p5-en/allreduce_ring_gauge_n_1.exe "0" "0"
    done
    done
   done
  done
