#!/bin/bash
#SBATCH -N4 --exclusive
#SBATCH --nodelist=p5en-odcr-queue-dy-p5en48xlarge-[5,36,41,45]
...
if [ "$NCCL_PROTO" = "Simple" ]; then
    ...
    run_gauge_test 1 "1/8"
    run_gauge_test 1 "1/4"
    run_gauge_test 1 "1/2"
    # run_gauge_test 1 1
    # run_gauge_test 2 2
    # run_gauge_test 4 4
    # run_gauge_test 8 8
    run_gauge_test 16 16
    # run_gauge_test 16 $(seq 4096 4096 65536)
    ...
    # run_gauge_test 4 16
    # run_gauge_test 8 32
    # run_gauge_test 16 64
    # run_gauge_test 16 $(seq 64 64 512)
    ...
    # run_gauge_test 8 4
    # run_gauge_test 16 8
    # run_gauge_test 16 $(seq 512 512 8192)
fi
